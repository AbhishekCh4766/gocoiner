...
class PressReleaseController extends Controller
{
      ...
      public function details($id)
    {
        ...
        $totalVolume =  $this->format_cash($totalVolume);
         ...
         $press_release = Press_release::where('id',$id)->get();

      return view('frontend.press_details', compact('pageSize','btcData','ethData','totalCap','totalVolume','liteData','press_release'));
    }
}    