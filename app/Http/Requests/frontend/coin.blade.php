...
@section('content')
    <div class="container">
                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="d-flex flex-row">
                            <div class="img-width"><img src="{{ asset('asset/images/coins/img/'. $coin->logo) }}"
                                               class="img-rounded"
                                               height="80"></div>
                            <div class="p-l-20">
        ...
        <div class="row graph-coin-section">
            @include('frontend.partials.coin_widget', ['col_size' => 3, 'title' => __('coin.price'), 'subtitle' => 'USD', 'price' => $coin->price_usd, 'footer' => (isset($coin->price_btc) && $coin->price_btc != 1) ? $coin->price_btc : '', 'footer_sub' => 'BTC'])
