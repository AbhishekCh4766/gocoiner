   ...
   <div class="four columns">
              <div data-id="26783" class="popup-event bend-content" style="clear:both;cursor: pointer; " id="{{$value->id}}" data-toggle="modal" data-target="#myModal_{{$count}}" data-backdrop="static" data-keyboard="false">
                <div class="twelve columns text-center" >
                    ...
                    <div class="three columns">
                       <span style="color:#548ffd !important;font-style: italic;text-align:     right;"><a href="{{$value->source}}" target="blank"> Link</a></span>
                    </div>
                   </div> 
                </div>
							...
							<span>Start Date: {{ \Carbon\Carbon::parse($value->created_date)->format('Y/d/m')}}</span>
							<span>End Date:  {{ \Carbon\Carbon::parse($value->date_event)->format('Y/d/m')}}</span>
							<button style="color:#548ffd !important;font-style: italic;text-align:     right;"><a href="{{$value->source}}" target="blank"> VISIT WEBSITE</a></button>
