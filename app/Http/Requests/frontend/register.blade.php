						...
						<span style="top: -11px; display: inline-block;background:#232e42; position: absolute; margin-left: -16px; font-size: 14px;">OR</span>
						    <div class="form-group">
							  ...
							  <div class="col-lg-12 input-box-social-icon">
								{{ Form::text('username', $username = null, array('class' => 'form-control input-md', 'placeholder' => '')) }}
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-12 input-box-social-icon">
							   {{Form::email('email', $value = null, array('class' => 'form-control input-md', 'placeholder' => ''))}} 
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-12 input-box-social-icon">
								{{Form::password('password', array('class' => 'form-control input-md', 'placeholder' => ''))}}
