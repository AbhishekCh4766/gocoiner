    ...
    <section id="wrapper">
        <div class="login-box card">
            <div class="card-block">
                <form class="form-horizontal form-material" method="POST" action="{{ route('auth.post_register') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Already have an account? <a href="{{ route('auth.login') }}" class="text-info m-l-5"><b>Sign
                                        In</b></a>
                            </p>
                        </div>
                    </div>
