...
class HomeController extends Controller
{
    ...
    {
        $pageSize = (int)session(Consts::SESSION_MAX_COINS, 500);
        ...
        return view('template', compact('top_coins', 'gainers', 'losers','coins','totalCap','totalVolume','btcData','ethData','liteData','PressData','EthNewsData','BitNewsData','RipNewsData','IcoNewsData','BloNewsData','CalData','getFeatNewsData'));
