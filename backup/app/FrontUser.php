...
class FrontUser extends Authenticatable
{
    ...
    protected $fillable = ['username', 'email', 'password'];
        ...
        //         'password_confirmation'=>['required_with:password_confirmation', 'confirmed'],
    ...
    // {
    //     return config('access.frontusers.change_email', false);
    // }
    ...
    // {
    //     return config('access.frontusers.requires_approval') && $this->confirmed == 0;
    // }
