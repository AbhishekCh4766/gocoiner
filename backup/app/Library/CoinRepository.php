...
class CoinRepository
{
   ...
   public static function getLiteData()
    ...
    public static function getPressData()
    {
        ...
        return  DB::table('press_release')->select('*')->orderBy('id', 'DESC')->take('03')->get();
     ...
     public static function getEthNewsData()
    {
        ...
        return  DB::table('news')->select('*')->where('category', 'like', '%ethereum news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }    

  public static function getBitNewsData()
    {
        
        return  DB::table('news')->select('*')->where('category', 'like', '%bitcoin news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }  

      public static function getRipNewsData()
    {
        
        return  DB::table('news')->select('*')->where('category', 'like', '%ripple news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }

          public static function getIcoNewsData()
    {
        
        return  DB::table('news')->select('*')->where('category', 'like', '%ico news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }

           public static function getBloNewsData()
    {
        
        return  DB::table('news')->select('*')->where('category', 'like', '%blockchain news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }
      ...
      public static function getallNewsData()
    {
        ...
        return  DB::table('news')->select('*')->get();
      }    
         public static function getFeatNewsData()
    {
        
        return  DB::table('news')->select('*')->where('category', 'like', '%cryptocurrency news%')->orderBy('last_updated', 'DESC')->limit(8)->get();
      }
