@include('layouts.includes.header-topbar')
                    ...
                    <div role="tabpanel" class="tab-pane active" id="featured-tab" >
                        ...
                        <div class="inner col-sm-6"  data-toggle="modal" class="myModal5" data-target="#myModal5_{{$count5}}" data-backdrop="static" data-keyboard="false">
                                ...
                                <a href="{{$data->url}}" target="_blank"
                                   class="pull-right btn btn-sm btn-rounded btn-outline-primary">{{ __('Read_more') }}
    ...
    <div class="prress-section">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-7 press-release">
                  ...
                  <button type="button" class="btn" onclick="location.href='{{url("/press-release")}}'">VIEW ALL PRESS RELEASE </button>
                            </div>
               </div>
        ...
        <div id="eventoncontent" style="height:100%; width:100%"></div>
                            <div class="view-button heat-map">
                                <button type="button" class="btn" onclick="location.href='{{url("/events")}}'" >VIEW UPCOMING EVENTS</button>
                            </div>
                        </ul>
                    </div>
